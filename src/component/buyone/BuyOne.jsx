...
function BuyOne() {
    ...
    return(
        <div className="max-w-7xl mx-auto flex flex-col bg-yellow p-5 border-t-solid border-t-2 border-lightGray">
            <div className="w-4/5 sm:w-11/12 mx-auto flex items-center flex-row justify-between mt-5">
                <div className="text-xl font-medium sm:text-base mobile:text-sm">Buy 1 Get 1</div>
